...
By joining our events, you agree to follow these guidelines and participate at your own risk. Let''s explore the mountains together safely!', NOW(), NOW()),
('Bay Area Cyclists', 'Cycling through the beautiful Bay Area routes', 'https://images.unsplash.com/photo-1541625602330-2277a4c46182?w=800', 1, 2, 'San Francisco, CA', 30, true, true, NULL, NOW(), NOW()),
('Morning Runners', 'Early morning running group for all levels', 'https://images.unsplash.com/photo-1476480862126-209bfaa8edc8?w=800', 1, 3, 'San Francisco, CA', 25, true, true, NULL, NOW(), NOW());
