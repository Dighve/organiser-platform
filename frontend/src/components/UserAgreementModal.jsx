...
export default function UserAgreementModal({ isOpen, onClose, onAccept }) {
  ...
  // Fetch current user agreement from backend
  const {
    data: agreementData,
    ...
    queryFn: async () => {
      console.log('🔄 Fetching current user agreement from backend...')
      const response = await legalAPI.getCurrentUserAgreement()
      console.log('✅ Agreement data fetched:', response.data)
        ...
        <div className="relative z-10 flex min-h-full items-center justify-center p-4">
          <div className="relative bg-white rounded-3xl shadow-2xl max-w-md w-full p-6">
            <div className="text-center">
              ...
              <p className="text-gray-600 mb-4">Unable to fetch the current user agreement. Please try again.</p>
